...
class TopologicalProtector(BaseQuantumProtector):
    ...
    def apply(self, state: QuantumState) -> QuantumState:
        ...
        # Normaliza estado
        protected_normalized = normalize_state(protected.vector)
        return QuantumState(protected_normalized, state.n_qubits)
